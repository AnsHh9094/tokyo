...
Tracks conversation context, pending intents, and last actions.
Based on Mark-X.1 temporary_memory.py by FatihMakes.
"""
...
class TemporaryMemory:
    ...
    def soft_reset(self):
        """Reset intents/params but keep conversation history."""
    ...
    def add_exchange(self, user_text: str, ai_response: str):
        """Alias for adding both user and AI to history."""
        pass  # Already handled by set_last_user_text / set_last_ai_response
